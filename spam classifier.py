...
# Reading a file
# nltk.download()  #this opens a UI to download all the packages related to this natural language toolkit.
# Only installing once should be fine.

trainingData_mails = pd.read_csv('TrainingData.csv')
testData_mails = pd.read_csv('TestData.csv')
...
print(spam_classifier._predict(
